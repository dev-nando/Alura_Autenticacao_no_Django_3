# Alura Cursos Online
## Curso de Autenticação no Django 3: formulários, requisições e mensagens
...
Código final criado durante o curso [Autenticação no Django 3: formulários, requisições e mensagens](https://cursos.alura.com.br/course/autenticacao-django-2), que faz parte da [Formação Django (_Criando sites e experiências na web com Python_)](https://cursos.alura.com.br/formacao-django).
